...
Senior AI engineer at [Refik Anadol Studio](https://refikanadolstudio.com/), building [Dataland](https://dataland.art/), AI agents, developer tools, and interactive technical essays.
...
- [capsarsiv.com](https://capsarsiv.com/) - Searchable independent archive for Turkish internet caps culture.
- [ScreenFit](https://screenfit.cobanov.dev/) - Visualize how retro consoles fit on modern handheld and monitor screens.
- [terminal.army](https://terminal.army/) - Terminal-native multiplayer space strategy game played through a CLI.
...
- [cobanov.dev](https://cobanov.dev/) - Writing, libraries, projects, and notes.
- [Repositories](https://github.com/cobanov?tab=repositories) - Older projects, experiments, and open source work.

## Focus

- Building useful products fast
- AI agents with complex memory
- Developer experience, automation, and internal tools
- Backend systems, vector databases, and generative AI pipelines

## Contact

Best way to reach me: [cobanov.dev](https://cobanov.dev/)
